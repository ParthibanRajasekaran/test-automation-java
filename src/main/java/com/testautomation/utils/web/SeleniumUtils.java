...
import static com.testautomation.utils.common.Logger.logDebug;
import static com.testautomation.utils.common.Logger.logError;
import static com.testautomation.utils.web.Waiters.*;
...
public class SeleniumUtils {
  ...
  public static void verifyElementPresent(final String locator) {
    if (isElementPresent(locator)) {
      Logger.logInfo(String.format("Element is present: %s", locator));
    } else {
  ...
  public static void verifyElementNotPresent(final String locator) {
    if (isElementNotPresent(locator)) {
      Logger.logInfo(String.format("Element %s is not present: ", locator));
    } else {
  ...
  public static void assertElementNotPresent(final String locator) {
    try {
      getFluentWait().until(ExpectedConditions.invisibilityOfElementLocated(By.xpath(locator)));
      Logger.logInfo(String.format("Element %s is present: ", locator));
    } catch (Exception ex) {
  ...
  public static void navigateToPage(String url) {
    Logger.logInfo(String.format("Navigating to web page %s", url));
  ...
  public static void navigateToPageWithJavascriptExecutor(String url) {
    Logger.logInfo(String.format("Navigating to web page %s with JavascriptExecutor ", url));
  ...
  public static void switchToFrame(String locator, String locatorWithinFrame) {
    ...
    Logger.logInfo("Switched to expected frame");
  }
  ...
  public static void switchBackFromFrame(String locatorOutsideFrame) {
    ...
    assertTrue(elementOnFrame.isDisplayed());
    Logger.logInfo("Switched back from frame");
  }
  ...
  public static void sendKeyTo(final String locator, final String key) {
    ...
    logDebug("Sucessfully sent key: " + key);
  }
  ...
  public static void uploadImage(final String locator, final String fileName) {
    ...
    logDebug("Image filename: " + filePath);
  ...
  public static void reloadPageIfElementIsNotPresent(final String locator) {
    try {
      ...
      Logger.logInfo(String.format("Page url is %s", getDriver().getCurrentUrl()));
      reload();
      reload();
      assertElementPresent(locator);
    }
  ...
  protected static void sleep(final int milliseconds) {
    try {
      ...
      logError("Thread Interrupted, this may cause tests to fail unexpectedly: " + e);
